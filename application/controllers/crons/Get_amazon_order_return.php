...
class Get_amazon_order_return extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->cronName = "Order Return Fetch Cron";
    }

    function index() {
        $content = date("d-m-Y H:i:s") . " " . "Order Return Fetch Cron Start";
        $this->logging->write_log($this->cronName, $content, 1, 0);
        $result = $this->feedback_setting_model->get_return_order_feedback_setting();
...
//                sleep(2);
                ...
                $content = date("d-m-Y H:i:s") . " AmzDateIteration Data is not Available." . " Order Return Fetch Cron.";
                $this->logging->write_log($this->cronName, $content, 1, 0);
            }
        }
        $content = date("d-m-Y H:i:s") . " " . "Order Return Fetch Cron End.";
