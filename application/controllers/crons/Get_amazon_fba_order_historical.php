...
class Get_amazon_fba_order_historical extends CI_Controller
{
    function __construct()
    {
        ...
        $this->cronName = "Historical FBA Order Fetch Cron";
    }

    function index()
    {
        $content = date("d-m-Y H:i:s") . " " . "Historical Order Fetch Cron Start";
        $this->logging->write_log($this->cronName, $content, 1, 0);
        $result = $this->feedback_fba_order_model->get_fba_order_feedback_setting_historical();
    ...
    function getfbaorderfromamazon($result)
    {
        ...
        foreach ($result->result() as $row) {
            $amzdateiteration= $this->feedback_fba_order_model->getamzdateiterationdata('OrderStatus',$row->ID_ACCOUNT);
