...
class Get_amazon_adjustment_inventory extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->cronName = "Amazon Inventory Adjustment Cron";
    }

    function index()
    {
        // Logging in database.
        $content = date("d-m-Y H:i:s") . " " . "Inventory Adjustment Cron Start";
        $this->logging->write_log($this->cronName, $content, 1, 0);
        $result = $this->feedback_setting_model->get_invetory_feedback_setting();
...
//                sleep(60);
                        ...
                        try {
                            ...
                            //$objAmazonReportRequestList->setTimeLimits('Feb 10, 2015',"Feb 21, 2015");
...
//                sleep(2);
                ...
                $content = date("d-m-Y H:i:s") . " AmzDateIteration Data is not Available." . " Inventory Adjustment Cron.";
                $this->logging->write_log($this->cronName, $content, 1, 0);
            }
        }
        // Logging in database.
        $content = date("d-m-Y H:i:s") . " " . "Inventory Adjustment Cron End.";
