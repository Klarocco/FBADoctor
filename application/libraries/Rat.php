...
class Rat
{
     ...
     * log something
     */
    public function write_log($cron_name="",$message="", $code = 0, $user_id = 0)
    {
        ...
        if($this->_set_message($message,$user_id,$code,$cron_name))
        {
            return TRUE;
        }
        else
    ...
    private function _set_message($message,$user_id,$code,$cron_name)
    {
