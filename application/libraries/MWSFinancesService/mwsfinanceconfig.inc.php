...
//        }
//    }
function mwsfinanceservice($className){
	$filePath = AMAZONMWSINVENTORYABSPATH.str_replace('_', DIRECTORY_SEPARATOR, $className) . '.php';
	if (file_exists($filePath)){
		include($filePath);
	}
}

spl_autoload_register('mwsfinanceservice');
